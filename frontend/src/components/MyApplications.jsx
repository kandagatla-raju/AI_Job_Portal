              ...
              {applications.map((element) => {
                return (
                  ...
                  <span>Status: </span><strong
                                           style={{
                                             color: element.status === "Accepted" ? "green" : "orange",
                                           }}
                                         >
                ...
                <button
                  onClick={() =>
                    navigate(`/contactEmployer?jobTitle=${element.jobInfo.jobTitle}&recruiterEmail=${element.jobInfo.jobId?.recruiterEmail || "N/A"}&companyName=${element.jobInfo.jobId?.companyName || "N/A"}`)
                ...
                >
                  Contact Recruiter
                      ...
                      {/* Delete Application button should be visible to both employers and job seekers */}
                      <button
                        className="outline_btn"
